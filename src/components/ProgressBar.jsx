const fills = {
  ...
  green:
    "bg-gradient-to-r from-fantasy-green to-fantasy-green-light shadow-[0_0_6px_rgba(92,161,54,0.3)]",
  yellow:
    "bg-gradient-to-r from-[#E6B422] to-flag-yellow shadow-[0_0_6px_rgba(244,196,48,0.3)]",
